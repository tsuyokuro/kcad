...
namespace Plotter.Serializer.v1001
{
    ...
    public class MpCadObjectDB_v1001
    {
        ...
        public static MpCadObjectDB_v1001 Create(CadObjectDB db)
        {
            ...
            ret.FigureList = MpUtil_v1001.FigureMapToMp_1001(db.FigureMap);
        ...
        public CadObjectDB Restore()
        {
            ...
            // Figure map
            List<CadFigure> figList = MpUtil_v1001.FigureListFromMp_1001(FigureList);
    ...
    public class MpFigure_v1001
    {
        ...
        {
            ChildList = MpUtil_v1001.FigureListToMp_1001(fig.ChildList);
        }
        ...
        public void RestoreTo(CadFigure fig)
        {
            ...
            if (ChildList != null)
            {
                fig.ChildList = MpUtil_v1001.FigureListFromMp_1001(ChildList);
